                  ...
                  {/* Carte "À venir" — visible uniquement sur le filtre All */}
                    ...
                    >
                      <div className="block project-card opacity-40 cursor-default select-none">
                        <div className="relative overflow-hidden bg-[#111110] aspect-[4/3] border border-dashed border-[var(--primary)]/15 flex flex-col items-center justify-center gap-4">
                          {/* Subtle grid pattern */}
